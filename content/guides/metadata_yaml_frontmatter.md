...
- `image` : lien vers l'image qui s'affiche sur la page d'accueil du site, lors du partage du contenu dans le flux RSS, la newsletter, les réseaux sociaux : [voir la page Cartes de partage](../internal/social_cards.md "Outillage interne : les Social Cards"). Format : PNG ou JPG. Dimensions : entre 600x300 et 800x400. Laisser vide pour une image générée automatiquement (voir [ci-dessous](#image-illustration-contenu)).
